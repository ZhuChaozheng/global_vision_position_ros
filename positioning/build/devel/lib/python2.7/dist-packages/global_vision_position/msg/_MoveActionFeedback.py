...
"""autogenerated by genpy from global_vision_position/MoveActionFeedback.msg. Do not edit."""
import sys
...
class MoveActionFeedback(genpy.Message):
  _md5sum = "0ed49eaa873252ff1800a34bab037b02"
  _type = "global_vision_position/MoveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','global_vision_position/MoveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = global_vision_position.msg.MoveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = global_vision_position.msg.MoveFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3d().pack(_x.feedback.present_car_x, _x.feedback.present_car_y, _x.feedback.present_car_theta))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.present_car_x, _x.feedback.present_car_y, _x.feedback.present_car_theta,) = _get_struct_3d().unpack(str[start:end])
      return self
